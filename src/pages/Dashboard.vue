...
import VmUserPreview from '@/components/dashboard/vm-user-preview.vue'
...
export default {
  ...
  methods: {
    setBreif: function(){
      this.dataUserPreview.brief.nick = this.userInfo.nick;
      this.dataUserPreview.brief.role = this.userInfo.role;
      this.dataUserPreview.property[0].value = this.userInfo.sex;
      this.dataUserPreview.brief.photo = 'http://localhost:8080/fiction-note/getPortrait?filename='+this.photo;
    }
  },
  computed: {
      userInfo: function(){
